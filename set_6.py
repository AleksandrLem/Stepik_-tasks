...
# получить множество, содержащее уникальные слова (в нижнем регистре)
...
in the darkest past, nothing of her subsists within the hollows and dells
of memory, over which, if you can still stand my style
...
words = {i.lower().strip(':,.!?();') for i in sentence.split()}
print(*sorted(words))