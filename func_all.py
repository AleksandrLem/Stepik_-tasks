...
# command – команда, которую нужно проверить,

# и возвращает значение True, если в команде содержится подстрока из
# списка ignore и False – если нет.
...
def ignore_command(command):
    ignore = ['alias', 'configuration', 'ip', 'sql', 'select',
